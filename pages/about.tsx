      ...
      <Card className=' pb-12 col-start-1 col-end-3 xl:box xl:col-start-3 xl:col-end-5 xl:row-start-1 xl:row-end-3 flex flex-col-reverse md:flex-row'>
        <div className='px-5'>
          ...
          <p className='font-normal  '>
            Full-stack nodeJs Developer specialized in front-end . 26 years old,
            I am passionate about creating and implementing solutions that make
            users lives easier. <span className='block mb-2' />I started my
            journey as a Front-end Developer in 2017, while studying at CPNV in
            Switzerland. In 2020 I did a bootcamp of coding to improve my
            backend skills.
